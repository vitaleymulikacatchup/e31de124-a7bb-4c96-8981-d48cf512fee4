...
export const metadata: Metadata = {
  title: "Heel Automotive | Premium Vehicle Selection",
  description: "Discover luxury vehicles and premium automotive solutions at Heel. Expert service, transparent pricing, and exceptional customer care.",
  keywords: "luxury cars, premium vehicles, automotive dealer, sports cars, sedan, financing",
  openGraph: {
    title: "Heel Automotive | Premium Vehicle Selection",
    description: "Discover luxury vehicles and premium automotive solutions. Expert service and transparent pricing.",
    type: "website",
    siteName: "Heel Automotive",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35eNGemlCEhFf8xGC6iUDmHzPTI/uploaded-1765985114198-kefvdcvs.jpg",
  ...
  twitter: {
    ...
    title: "Heel Automotive | Premium Vehicles",
    description: "Discover luxury vehicles curated for discerning buyers.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35eNGemlCEhFf8xGC6iUDmHzPTI/uploaded-1765985114198-kefvdcvs.jpg"]
  }
};
